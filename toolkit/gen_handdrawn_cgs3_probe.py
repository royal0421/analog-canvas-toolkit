...
f = Schematic(
    ...
    supply_net="net-top", nmos_bulk_net="net-gnd")
...
f.route("r-t-2", "net-top", Jn("JT2"), [("to", Jn("JT3"))])
...
f.build(long_haul={"r-t-2",        # 70: the rail across to M_3's source
